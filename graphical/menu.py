...
def manual_menu():
    ...
    print(red + '                                 [' + yellow + '9' + red + ']' + blue + ' Geolocation')
    ...
    print(" ")
    print(red + '[' + yellow + '11' + red + ']' + blue + ' Get File Hash', end='')
    print(red + '                             [' + yellow + '13' + red + ']' + blue + ' Exiftool')
    print(red + '[' + yellow + '12' + red + ']' + blue + ' Analyse Attachment', end='')
    print(red + '                        [' + yellow + '14' + red + ']' + blue + ' Strings')
    print(red + '                                               [' + yellow + '15' + red + ']' + blue + ' hexdump')
    print(red + '                                               [' + yellow + '16' + red + ']' + blue + ' Pdf id')
    print(red + '                                               [' + yellow + '17' + red + ']' + blue + ' Pdf Parser')
    print(red + '                                               [' + yellow + '18' + red + ']' + blue + ' Office Doc Analyse & Macro')
    print(" ")
    print(" ")
    print(" ")
    print(green + '[*]' + white + " Url Interaction " + green + '[*]')
    print(" ")
    print(red + '[' + yellow + '19' + red + ']' + blue + ' Url Authenticity')
    print(red + '[' + yellow + '20' + red + ']' + blue + ' Url Decode')
    print(red + '[' + yellow + '21' + red + ']' + blue + ' Http Header & Status Code')
    print(red + '[' + yellow + '22' + red + ']' + blue + ' Html Text')
    print(" ")
    print(" ")
    print(" ")
    print(white + '\n[' + green + '75' + white + ']' + yellow + ' Get Menu', end='')
